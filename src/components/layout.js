...
import { container, heading,navLinkText, navItem, navCont,siteTitle} from './layout.module.css';
        ...
        <main className = {container}>
            ...
            <nav>
                <ul className ={navCont}>
                    ...
                    <li className = {navItem }><Link className= {navLinkText} to ="/blog">Blog</Link></li>
                </ul>
            </nav>
